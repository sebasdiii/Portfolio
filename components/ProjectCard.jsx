    ...
    return(
        <div>
            ...
            style={{ background: `url(${imgUrl})`, backgroundSize: "cover" }}>
                ...
                <div className="overlay justify-center items-center  top-0 left-0 w-full h-full hidden group-hover:flex group-hover:bg-opacity-80 transition-all duration-500 ">
                    <Link
                        href={gitUrl}
